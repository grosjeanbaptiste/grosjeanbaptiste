...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    ...
    <html>
      <head>
        <title>
          <xsl:value-of select="/resume/basics/name" /> - CV</title>
        <meta charset="UTF-8" />
        <style>
        ...
        <div class="section">
          ...
          <ul>
            <xsl:for-each select="/resume/basics/profiles">
              <li>
                <strong>
                  <xsl:value-of select="network" /> :</strong>
                <a href="{url}">
